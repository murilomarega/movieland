...
export const ENDPOINT_SEARCH = ENDPOINT+'/search/movie'
export const ENDPOINT_MOVIE = ENDPOINT+'/movie/'  

export const STARRED_MOVIES = 'starred';
export const WATCH_LATER = 'watch-later';

// fetch('https://api.themoviedb.org/3/movie/1038672?language=en-US', options)
